...
//   // Capture the *currently visible* tab in the active window
//   chrome.tabs.captureVisibleTab(
//     /* windowId */ null,
//     /* options  */ { format: "png", quality: 100 },
//     dataUrl => {
...
//         return;
//       }
//       // Store it so you can inspect or display it later
//       chrome.storage.local.set({ lastBuildScreenshot: dataUrl }, () => {
//         console.log("✅ screenshot saved to storage");
//       });
//     }
